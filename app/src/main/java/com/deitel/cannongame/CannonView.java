...
public class CannonView extends SurfaceView
   ...
   public static final int BLOCKER_BOUNCE = 3;
   ...
   public CannonView(Context context, AttributeSet attrs) {
      ...
      soundMap.put(BLOCKER_BOUNCE,
              soundPool.load(context, R.raw.bouncing, 1));
   ...
   public void newGame() {
      ...
      blocker = new Blocker(this, Color.BLACK, MISS_PENALTY,
         ...
         (int) ((0.5 - BLOCKER_LENGTH_PERCENT / 2) * screenHeight + scoreManager.getLevel()),
         (int) (BLOCKER_WIDTH_PERCENT * screenWidth),
         (int) (BLOCKER_LENGTH_PERCENT * screenHeight + scoreManager.getLevel()),
   ...
   private void updatePositions(double elapsedTimeMS) {
      ...
      if (timeLeft <= 0) {
         ...
         showGameOverDialog(R.string.lose,  scoreManager.saveScore()); // show the losing dialog
      ...
      if (targets.isEmpty()) {
         cannonThread.setRunning(false); // terminate thread
         showGameOverDialog(R.string.win, null); // show winning dialog
   ...
   private void showGameOverDialog(final int messageId, final String score) {
         ...
         new DialogFragment() {
            ...
            public Dialog onCreateDialog(Bundle bundle) {
               ...
               if (messageId == R.string.lose)
                  ...
                  builder.setTitle(getResources().getString(messageId, scoreManager.getLevel() - 1));
   ...
   public void drawGameElements(Canvas canvas) {
      ...
      canvas.drawText(getResources().getString(
              R.string.level, scoreManager.getLevel()), 50, 175, textPaint);
   ...
   public void testForCollisions() {
      ...
      if (cannon.getCannonball() != null &&
         ...
         blocker.updateBlockerLength(blocker.getLength() + (blocker.getLength() * 5 / 100));
